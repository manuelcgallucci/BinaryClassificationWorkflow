...
class TestSum(unittest.TestCase):
    def test_import_data_replacements(self):
        ...
        for replace_value in replace_values:
            data, label = wf.import_data("./data/test/test_data.csv", ["dummy", "int", "float", "label"], true_label_str=None,normalize=None, class_label="last", dummy_cols=["dummy"], replace_nan=replace_value, random_state=None)
